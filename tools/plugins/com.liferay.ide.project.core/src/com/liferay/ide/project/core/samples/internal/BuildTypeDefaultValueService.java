 ...
 * @author Seiphon Wang
 */
public class BuildTypeDefaultValueService extends DefaultValueService {
	...
	protected String compute() {
		...
		String defaultProjectBuildType = preferencesService.getString(
			ProjectCore.PLUGIN_ID, ProjectCore.PREF_DEFAULT_SAMPLE_PORTLET_PROJECT_BUILD_TYPE_OPTION, null,
			prefContexts);
