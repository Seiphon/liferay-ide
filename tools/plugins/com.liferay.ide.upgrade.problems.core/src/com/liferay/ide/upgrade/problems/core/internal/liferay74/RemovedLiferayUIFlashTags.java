...
@Component(
	property = {
		...
		"problem.section=#removed-the-liferay-ui:flash-tag",
		"problem.summary=The tag liferay-ui:flash is no longer available", "problem.tickets=LPS-121732", "version=7.4"
	},
	service = FileMigrator.class
)
public class RemovedLiferayUIFlashTags extends JSPTagMigrator {

	public RemovedLiferayUIFlashTags() {
